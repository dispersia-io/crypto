...
2. Click on **Report a vulnerability** (or use [this direct link](https://github.com/dispersia-io/crypto/security/advisories/new)).
...
1. Send an email to **[security@dispersia.io](mailto:security@dispersia.io)**.
2. Include the word `[SECURITY]` in the subject line.
3. Provide the following details:
   - The package version(s) affected (e.g., `1.0.0` or `2.0.0-canary.2`).
